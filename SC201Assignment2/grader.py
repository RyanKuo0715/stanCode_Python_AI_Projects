...
Name: Ryan Kuo
-----------------------------
Milestone 4 answer: Train error declines sharply from 0.03601575689364097(numEpochs=40)
to 0.009566685424873381(numEpochs=90), but validation error just fluctuates between
0.261 and 0.268, even rising from 0.26139561057962857 to 0.2658975801913337 between
numEpochs=70 and 90.
"""
...
# Your answer here
# The train error of extractCharacterFeatures is 0, while that of extractWordFeatures is about 0.036 when epoch is 40.
# But the validation error of extractCharacterFeatures is a little bit higher than that of extractWordFeatures,
# 0.27687113111986494 and 0.26730444569499157 respectively.
# On the other hand, training time of extractCharacterFeatures is about 5 times that of extractWordFeatures.
# extractCharacterFeatures creates more tokens for training than extractWordFeatures does, therefore generates the
